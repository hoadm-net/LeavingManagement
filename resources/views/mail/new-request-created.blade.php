<div>
        ...
        <table style="border: none;">
            <tr>
                <td style="width: 50%;">@if($paid_leave) ✅ @else ❌ @endif Paid leave: {{ $paid_leave + 0 }} (days)
                    -  Unpaid leave: {{ $unpaid_leave + 0 }} (days)</td>
    ...
    <p style="color: #1d4ed8">{{ __("A new leave request requires approval.") }} <a href="{{ route('dashboard') }}" target="_blank">{{ __("Please log in to the system to review it.") }}</a></p>
</div>
